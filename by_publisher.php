...
WHERE media.publisher_id = {$_GET['publisher_id']};
";
...
function sqlToTable() {
	...
	echo '<tr><th>image<br>(click)</th><th>isbn</th><th>type</th><th>title</th><th>author</th><th class="d-none d-lg-table-cell description">description</th><th>publisher</th><th>date</th><th>status</th><th colspan="2"><a href="insert.php"><button class="btn btn-success"><i class="fas fa-wrench"></i> <i class="fas fa-plus"></i></button></a></th></tr>';
